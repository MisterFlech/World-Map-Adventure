...
public class AudioManagerOld : MonoBehaviour
{
    ...
    */
    ...
    public void PlayMusic(AudioClip song, float maxVolume = 1f, float pitch = 1f, float startingVolume = 0f, bool playOnStart = true, bool loop = true)
    {
        //AudioClip song = CreateAudioClip(songName, "Audio/Music");
        if (song != null)
        {
